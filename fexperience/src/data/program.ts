...
export const programs: Record<string, ProgramDay[]> = {
  ...
  'sa-program': [
    ...
    },
    {
      day: 5,
      title: 'ВЭД',
      description: 'Обсуждение ключевых торговых маршрутов, портов, логистики и управления цепочками поставок. Анализ правовых и нормативных требований, включая налогообложение, валютный контроль и защиту инвестиций.',
