      ...
      <div className="overflow-hidden py-20 pl-2" ref={emblaRef}>
        <div className="flex">
          {items.map((item, index) => (
            <div key={index} className="flex-[0_0_380px] sm:flex-[0_0_420px] md:flex-[0_0_360px] min-w-0 pl-6 md:pl-12">
              {/* Контейнер карточки с фиксированной высотой */}
              <div className="relative w-full h-[320px]">

                {/* 1. Нижняя карточка-подложка (Серый фон) */}
                <div className="absolute bottom-0 left-0 w-full h-[254px] bg-[#2A2A2A] rounded-[23px] overflow-hidden">
                  <Image
                ...
                <div className="absolute -top-6 right-[-20] w-[85%] h-[190px] rounded-[28px] overflow-hidden shadow-xl z-10 bg-[#1A1A1A]">
                  <Image
